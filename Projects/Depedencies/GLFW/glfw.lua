project "GLFW"
    ...
    filter { "system:linux", "files:force_cmake_build.c" }
        ...
        cmakeOut = _ARS3D_OBJECT_DIR .. "/src/libglfw3.a"
        target   = _ARS3D_TARGET_DIR .. "/libglfw3.a"
    ...
    filter { "system:windows", "files:force_cmake_build.c" }
        ...
        -- These two variables MUST be adjusted based on the specific names Cmake produces!!!
        cmakeOut = _ARS3D_OBJECT_DIR .. "/src/%{cfg.buildcfg}/glfw3.lib"
        target   = _ARS3D_TARGET_DIR .. "/glfw3.lib"
